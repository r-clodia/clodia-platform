...
| R9 | [#187](https://github.com/r-clodia/clodia-platform/issues/187) | i tre pezzi ci sono, la sequenza no — **rimediato** il 19 ago, [`clodia-logic#338`](https://github.com/r-clodia/clodia-logic/pull/338) |
