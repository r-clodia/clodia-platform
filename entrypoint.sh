...
GIT_REPO_SLUG="${GIT_REPO:-ddbit/clodia-logic}"
...
if [ -f /clodia/secrets/github_token_ddbit ]; then
    GIT_TOKEN="$(tr -d "\n\r" < /clodia/secrets/github_token_ddbit)"
fi
